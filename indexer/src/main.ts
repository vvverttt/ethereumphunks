...
if (!process.env.ALLOWED_ORIGINS) {
  process.env.ALLOWED_ORIGINS = 'http://localhost:9000,http://localhost:4200,https://ethereumphunks-git-market-vvverttts-projects.vercel.app,https://etherphunks.eth.limo,https://quantumphunks.com,https://www.quantumphunks.com,https://ethereumphunks.pages.dev';
}
