...
export class IndexComponent {
  ...
  collectionFaqs: Record<string, { q: string; a: string }[]> = {
    ...
    'phikings': [
      ...
      { q: 'Where does the market data on this site come from?', a: 'The prices and sales you see on this site are loaded from the marketplace contracts on the Ethereum blockchain.' },
      { q: 'Are they an ERC-721 token?', a: 'No. They are Ethscriptions, not ERC-721 tokens. Ownership is managed on-chain through our smart contracts and Ethereum transfer history.' },
      { q: 'Do you charge any fees for transactions?', a: 'Phikings buy and sell on the EtherPhunks market, so those fees follow that marketplace — not our 5% royalty. Bids run through the QuantumPhunks market, so an accepted bid does carry the 5% royalty.' },
      { q: 'How do bids work?', a: 'Place a bid and your ETH locks in the QuantumPhunks marketplace contract. Because Phikings are listed on the EtherPhunks market, the owner first withdraws the item from there, then accepts your bid here; you confirm after a short 5-block cooldown to complete the purchase. Your ETH stays safe and is withdrawable anytime before the bid is accepted.' },
    ],
    'ethsrocks': [
