...
export class IndexComponent {
  ...
  collectionFaqs: Record<string, { q: string; a: string }[]> = {
    ...
    'ethsrocks': [
      { q: 'How are EthsRocks set up and distributed?', a: 'EthsRocks are live, and the first collection we brought to our auction house, forked from Chopperdad. The 100 normal EthsRocks were airdropped to 77 unique wallets that never sold or listed their Missing Phunks or DystoPhunks under 0.67 ETH, with some receiving two, and are now in their holders\' hands. We hold 6 infinity stones, to be distributed at a later time.' },
      { q: 'How do bids work?', a: 'Place a bid and your ETH locks in the marketplace contract. The owner accepts your bid, then you confirm after a short 5-block cooldown to complete the purchase. Your ETH stays safe the whole time — you can withdraw it anytime before it\'s accepted, and it\'s auto-refunded if the item sells to someone else.' },
    ],
  };
