...
export class IndexComponent {
  ...
  defaultFaq = [
    ...
    { q: 'Do you charge any fees for transactions?', a: 'There are no marketplace trading fees. There is a 5% royalty on every sale, routed on-chain to the QuantumPhunks treasury (quantumphunks.eth).' },
  ];
