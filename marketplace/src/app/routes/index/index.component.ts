...
export class IndexComponent {
  ...
  defaultFaq = [
    ...
    { q: 'Are these collections live?', a: 'Not yet. QuantumPhunks, Quantum Missing Phunks, and Quantum DystoPhunkz are for viewing only right now. Distributions, mechanics, and price have not been announced.' },
