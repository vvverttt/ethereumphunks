...
export class IndexComponent {
  ...
  collectionFaqs: Record<string, { q: string; a: string }[]> = {
    'og-missing-phunks': [
      ...
      { q: 'Do you charge any fees for transactions?', a: 'Missing Phunks trade on the EtherPhunks market, so their fees follow that marketplace — not our 5% royalty.' },
    ],
    'og-dysto-phunks': [
      ...
      { q: 'Do you charge any fees for transactions?', a: 'DystoPhunks trade on the EtherPhunks market, so their fees follow that marketplace — not our 5% royalty.' },
    ],
    'ethsrocks': [],
  };
