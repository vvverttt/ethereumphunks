...
import { CollectionSalesComponent } from '@/components/collection-sales/collection-sales.component';
...
export class IndexComponent {
  ...
  defaultFaq = [
    ...
    { q: 'Are these collections live?', a: 'Not yet. QuantumPhunks are for viewing only right now. Nothing has been announced.' },
    { q: 'What\'s the total supply and mechanics?', a: 'Coming soon.' },
    { q: 'Why is everything here before launch?', a: 'The full collections are here, complete and matching our introduction, including the first full set of Turtles. We\'re showing it all ahead of launch on purpose, so there\'s no confusion about the effort behind it. Proof of dankness. See it for yourself.' },
    { q: 'What exactly is going on here?', a: 'This is the home of DystoLabz collections. A marketplace for buying, selling, and exploring QuantumPhunks and related collections. All transactions happen on-chain through smart contracts originally forked from Chopperdad\'s <a href="https://etherphunks.eth.limo/" target="_blank" rel="noopener noreferrer">EtherPhunks Market</a> and Phunks Auction House, built upon and evolved by DystoLabz.' },
    { q: 'How do I get one?', a: 'Coming soon.' },
  ...
  collectionFaqs: Record<string, { q: string; a: string }[]> = {
    'cryptophunksv67': [
      { q: 'What are QuantumPhunks?', a: 'QuantumPhunks are a culture-driven extension of the punk format, born from the Phunks ethos of anti-corporate values and decentralized open-source spirit. Created by Vert and Arkan, we begin from original punk combinations translated onto animal-based characters, with new combinations introduced, weaker pairings replaced, and hundreds of one-of-one pieces constructed by hand. Roughly 50 to 67 percent of the work was hand-manipulated through editing CSV trait generation files, adding traits to generation runs, selectively regenerating outputs, and performing manual trait and image edits throughout. Custom scripts and AI-assisted tools supported generation and trait assembly, but authorship remained hands-on at every stage. Every piece is stored fully on-chain as an Ethscription, inscribed directly into the calldata of Ethereum transactions. No IPFS, no Arweave, no external servers. Ethereum acts as the sole source of truth, preserving the data exactly as it was inscribed. The format extends beyond 10,000 through a deliberate numbering system that incorporates Missing Phunks from #10,000 to #10,250, DystoPhunkz from #10,251 onward, and EthsRocks, completing the collection as a structured evolution of the punk format. 1,481 unique trait values across 25 trait types, including 10 Phunk types, 16 variants, 719 total one-of-ones, many hidden details, and hidden one-of-ones. Drawing from decades of punk derivatives, themes, culture, memes, nostalgia, and history, QuantumPhunks are a comprehensive 24x24 study of the punk format, built to move the culture forward while honoring its roots.' },
      { q: 'Are they an ERC-721 token?', a: 'Yes. CryptoPhunksV67 is a fully on-chain ERC-721C. Ownership is standard ERC-721 (transfers and approvals) with ERC-721C creator-token transfer rules, enforced entirely by the contract.' },
      { q: 'Where are the images stored for the Phunks?', a: 'Fully on-chain. Every phunk image is stored inside the contract itself via SSTORE2, and the contract\'s tokenURI renders it as a crisp, pixel-perfect SVG. No IPFS, no servers, no off-chain hosting.' },
      { q: 'How are the traits and metadata handled?', a: 'The traits and metadata live on-chain and are returned by the contract\'s tokenURI as standard ERC-721 metadata (name, image, attributes).' },
      { q: 'Where does the market data on this site come from?', a: 'The prices, bids and sales you see on this site are loaded from the QuantumPhunksMarket ERC721C contract on the Ethereum blockchain.' },
      { q: 'Do you charge any fees for transactions?', a: 'A 5% royalty (ERC-2981) is paid on every sale, routed on-chain to the collection\'s royalty receiver.' },
      { q: 'How do bids work?', a: 'You can bid a few ways: a single-item bid on one specific phunk (placing a higher bid outbids the current one), a collection bid on any phunk in the collection, or bulk bids across multiple items at once. Your ETH locks in the QuantumPhunksMarket contract when you bid, and the owner accepts it to complete the sale with the 5% royalty applied. Your ETH stays safe the whole time — you can withdraw it anytime before it\'s accepted, and it\'s auto-refunded if the item sells to someone else.' },
    ],
    'missing-phunks': [
      ...
      { q: 'Do you charge any fees for transactions?', a: 'Missing Phunks buy and sell on the <a href="https://etherphunks.eth.limo/" target="_blank" rel="noopener noreferrer">EtherPhunks market</a>, so those fees follow that marketplace — not our 5% royalty. Bids run through the QuantumPhunks market, so an accepted bid does carry the 5% royalty.' },
      { q: 'How do bids work?', a: 'Place a bid and your ETH locks in the QuantumPhunks marketplace contract. Because Missing Phunks are listed on the <a href="https://etherphunks.eth.limo/" target="_blank" rel="noopener noreferrer">EtherPhunks market</a>, the owner first withdraws the item from there, then accepts your bid here; you confirm after a short 5-block cooldown to complete the purchase. Your ETH stays safe and is withdrawable anytime before the bid is accepted.' },
    ],
    'dysto-phunks': [
      { q: 'What are DystoPhunks?', a: 'An extension of CryptoPhunks and Missing Phunks, crafted as Ethscription digital artifacts, DystoPhunkz spans CryptoPhunks #10,251–10,319 and is minted and stored fully on-chain using Ethscriptions. These digital artifacts are inscribed directly on the Ethereum blockchain using etherscribe, with no IPFS or off-chain storage. Featured on the <a href="https://etherphunks.eth.limo/" target="_blank" rel="noopener noreferrer">EtherPhunks market</a> as its third curated collection, DystoPhunkz is a follow-up project to Missing Phunks and CryptoPhunks, consisting of a total supply of 69 characters numbered 10,251–10,319, introducing new rare traits and drawing inspiration from DystoPunks and Cyber Ordinals by Avocato. DystoPhunkz is based on a neon green theme outline and uses a dark green tone as its base color. The HEX code used for DystoPhunkz is #0d1b01, while OG Phunks use #000000. Since DystoPunks use a blue-toned theme, a green-toned base was used here, with all pure black replaced by this tone. Species color treatments vary across the collection. Aliens use cooler color tones, Apes blend toward dark purple, Zombies feature a fresher green typical of the dysto world, and Robots adopt gray metallic colors with antennas on their heads. The characters include Cyborgs, Robots, Zombies with brain rot, and Human evolution. Cyborgs are characterized by dominant facial line markings with color variations across alien, ape, and human versions and are the rarest type, with only 9 in the collection. Robots feature antennas that light up on their heads, metallic silver skin color, and wire teeth. Zombies include two types, one characterized by brain rot with flies and exposed brain on the left side of the head. Human evolution includes male and female characters marked by neon green facial stripes, representing the main group that first evolved within the dysto world. Traits in DystoPhunkz emphasize a neon green theme with maximum customization. Hair colors include neon green, white, purple, and pink, with updated models from OG Phunks such as Cyberbrain, Pompadour, Pink Rose, and Exotic Black. Eye traits focus on future-themed VR goggles in multiple models, while masks were developed as rare traits designed specifically to match the dystopian atmosphere of the collection. The rarest characters and traits consist of a mix of OG Phunks development and new designs. Notable pieces include Philip from CryptoPhunks V1 evolved into a cyborg and unique in the collection, Police Robots inspired by original bot Phunks with upgraded color suits and neon green VR, Next Gen Phunkbots inspired by Phunkbot with upgraded VR goggles and neck covers, Green Phunks male and female cyber residents inspired by Missing Phunks and the <a href="https://etherphunks.eth.limo/" target="_blank" rel="noopener noreferrer">EtherPhunks</a> logo and included among the 9 rare cyborgs, and helmet characters that exist as rare 1/1 items featuring full helmet coverage, VR glasses, and special masks.' },
      { q: 'Do you charge any fees for transactions?', a: 'DystoPhunks buy and sell on the <a href="https://etherphunks.eth.limo/" target="_blank" rel="noopener noreferrer">EtherPhunks market</a>, so those fees follow that marketplace — not our 5% royalty. Bids run through the QuantumPhunks market, so an accepted bid does carry the 5% royalty.' },
      { q: 'How do bids work?', a: 'Place a bid and your ETH locks in the QuantumPhunks marketplace contract. Because DystoPhunks are listed on the <a href="https://etherphunks.eth.limo/" target="_blank" rel="noopener noreferrer">EtherPhunks market</a>, the owner first withdraws the item from there, then accepts your bid here; you confirm after a short 5-block cooldown to complete the purchase. Your ETH stays safe and is withdrawable anytime before the bid is accepted.' },
    ],
    'phikings': [
      { q: 'What are Phikings?', a: '(Phunks + Vikings) Phikings is the latest handcrafted extension of the punk/phunk format, built around Viking history and Norse mythology. Minted fully on-chain as Ethscriptions, the collection draws from the Aesir gods, the primordial giants, and the sagas themselves, with every character designed from the ground up as a true 1/1. Numbered #10,320–10,386, Phikings continues the DystoLabz extension series that started with Missing Phunks (#10,000–10,250), a handcrafted completion of gaps left in the original CryptoPunks and Missing Punks trait systems. It continued with DystoPhunks (#10,251–10,319), a neon-green cyberphunk evolution of DystoPunks, Cyber Ordinals, and CryptoPhunks. Phikings moves beyond derivatives of derivatives, introducing a theme never seen before in punk derivatives.' },
      { q: 'What exactly is going on here?', a: 'This is the home of DystoLabz collections. A marketplace for buying, selling, and exploring QuantumPhunks and related collections. All transactions happen on-chain through smart contracts originally forked from Chopperdad\'s <a href="https://etherphunks.eth.limo/" target="_blank" rel="noopener noreferrer">EtherPhunks Market</a> and Phunks Auction House, built upon and evolved by DystoLabz.' },
      ...
      { q: 'Where does the market data on this site come from?', a: 'The prices and sales you see on this site are loaded from the marketplace contracts on the Ethereum blockchain.' },
      { q: 'Are they an ERC-721 token?', a: 'No. They are Ethscriptions, not ERC-721 tokens. Ownership is managed on-chain through our smart contracts and Ethereum transfer history.' },
      { q: 'Do you charge any fees for transactions?', a: 'Phikings buy and sell on the <a href="https://etherphunks.eth.limo/" target="_blank" rel="noopener noreferrer">EtherPhunks market</a>, so those fees follow that marketplace — not our 5% royalty. Bids run through the QuantumPhunks market, so an accepted bid does carry the 5% royalty.' },
      { q: 'How do bids work?', a: 'Place a bid and your ETH locks in the QuantumPhunks marketplace contract. Because Phikings are listed on the <a href="https://etherphunks.eth.limo/" target="_blank" rel="noopener noreferrer">EtherPhunks market</a>, the owner first withdraws the item from there, then accepts your bid here; you confirm after a short 5-block cooldown to complete the purchase. Your ETH stays safe and is withdrawable anytime before the bid is accepted.' },
    ],
    'ethsrocks': [
      { q: 'How are EthsRocks set up and distributed?', a: 'EthsRocks are live, and the first collection we brought to our auction house and market, forked from Chopperdad. Most of the 100 normal EthsRocks were airdropped to 77 unique wallets that never sold or listed their Missing Phunks or DystoPhunks under 0.67 ETH, with some receiving two, and are now in their holders\' hands. The rest went to test our auction house, with a total of 8 that went to auction at zero reserve. We hold 6 infinity stones, to be distributed at a later time.' },
      { q: 'Do you charge any fees for transactions?', a: 'Yes, there is a 5% royalty on every sale.' },
      { q: 'How do bids work?', a: 'Place a bid and your ETH locks in the marketplace contract. The owner accepts your bid, then you confirm after a short 5-block cooldown to complete the purchase. Your ETH stays safe the whole time — you can withdraw it anytime before it\'s accepted, and it\'s auto-refunded if the item sells to someone else.' },
    ],
  };
