...
// New (correct) hashIds — remaining 19 (#10004,#10015,#10058,#10078 already withdrawn)
const REMAINING_HASHIDS = [
  // Quantum Missing Phunks — 4 remaining
...
async function main() {
  ...
  console.log(`\nWithdrawing ${REMAINING_HASHIDS.length} remaining tokens (new hashIds)...\n`);

  let success = 0, failed = 0;

  for (const hashId of REMAINING_HASHIDS) {
    try {
