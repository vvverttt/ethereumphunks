...
const _playPrice = hre.ethers.parseEther('0.167');
...
export async function deployPhilipLottery() {
  ...
  console.log('\n=====================================================================');
  console.log(`Deploying ${contractName} (second instance) with account:`, signer.address);
  console.log('=====================================================================');
  ...
  console.log('\n=====================================================================');
  console.log('SUMMARY:');
  console.log(`  PhilipLotteryV68 (2): ${address}`);
  ...
  console.log('  3. Deposit prizes (send ethscriptions to this contract)');
  console.log('  4. Update lottery2Address in frontend environment configs');
  console.log('=====================================================================\n');
}
