...
async function main() {
  ...
  console.log('\n=====================================================================');
  console.log('Upgrading Mutation (Evolve) implementation');
  ...
  // Storage manifest is stale (from old layout before fresh V3-era deploy).
  // We're only appending __gap + renounceOwnership.
